  ...
  const handleCompletion = async () => {
    ...
    try {
      if (!photo) {
        ...
        alert(
          "Photo is required to complete experience. Click the camera icon to add an image.",
        );
        return;
      }
    ...
    >
      ...
      <div className="flex flex-col gap-4 items-center w-full">
        <div className="flex flex-col items-start text-left w-full">
          ...
          <span className="text-sm text-[#A16A4B] font-light">{notes}</span>
          ...
          <div className="my-3 flex w-full flex-col items-center gap-7 rounded-3xl border-2 border-dashed border-[#D7CEC6] bg-[#FFFCF7] p-5 sm:p-10">
            ...
            <div className="flex flex-col gap-1 text-center">
              ...
              <span className="text-[#877163] text-sm">
                Pick a date, bring your favorite cozy things, and turn this plan
                into a shared memory together.
              </span>
            </div>
